...
public class StepDefSettings {
    ...
    public void click_on_Album_from_ADMIN_drop_down() throws Throwable {
        ...
        Thread.sleep(2000);
        WebElement myAccount = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[1]/div/div/nav/div/div/ul/li[8]/ul/li[9]/a")));
        Thread.sleep(1000);
    ...
    public void user_should_be_able_to_land_on_album_page() throws Throwable {
        ...
        Assert.assertEquals("http://192.168.0.27:5000/dashboard/generalSettings",url);
        Thread.sleep(1000);
    }
    ...
    public void select_hr_name_and_disable_attendance_mail() throws Throwable {
        //Thread.sleep(3000);
        //driver.findElement(By.id("react-select-2-option-0")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div[2]/div/div[1]/div/div/div[5]/label/span")).click();
    }

    @And("Click on UPDATE SETTINGS button")
    public void click_on_update_settings_button() throws Throwable {
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div[2]/div/div[2]/div/button")).click();
    }

    @Then("Setting should updated successfully")
    public void setting_should_updated_successfully() throws Throwable {
